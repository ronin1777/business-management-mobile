...
import type { DashboardSupplier } from "@/types/dashboard";

type SupplierPayablesProps = {
        ...
        {payables.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              در حال حاضر بدهی به تأمین‌کننده‌ای وجود ندارد.
            </Text>
          </View>
        ) : (
